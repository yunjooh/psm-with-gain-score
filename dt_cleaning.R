...
mk_student_df$edutech_feel_3 <- ifelse(mk_student_df$'STM3_56_1' %in% c(4, 5), 1, 0)
...
mm_student_df$edutech_feel_3 <- ifelse(mm_student_df$'STM3_56_1' %in% c(4, 5), 1, 0)
...
me_student_df$edutech_feel_3 <- ifelse(me_student_df$'STM3_56_1' %in% c(4, 5), 1, 0)
...
mk_final_df <- merge(mk_student_subset, mk_school_subset, by = "SCHID")

mk_final_df$did_k <-mk_final_df$STM3_K_VER - mk_final_df$STM2_K_VER


###math-students-schools
...
mm_final_df <- merge(mm_student_subset, mm_school_subset, by = "SCHID")

mm_final_df$did_m <-mm_final_df$STM3_M_VER - mm_final_df$STM2_M_VER


###English-students-schools
...
me_final_df <- merge(me_student_subset, me_school_subset, by = "SCHID")

me_final_df$did_e <-me_final_df$STM3_E_VER - me_final_df$STM2_E_VER


write.csv(mk_final_df, file="m_korean_final_2.csv")
write.csv(mm_final_df, file="m_math_final_2.csv")
write.csv(me_final_df, file="m_eng_final_2.csv")
