...
#load files
#mk_final_df_345 <- read.csv("G:/내 드라이브/2025연구/SELS2020/m_korean_final_3.csv")
#mm_final_df_345 <- read.csv("G:/내 드라이브/2025연구/SELS2020/m_math_final_3.csv")
#me_final_df_345 <- read.csv("G:/내 드라이브/2025연구/SELS2020/m_eng_final_3.csv")

mk_final_df<- mk_final_df_345
mm_final_df<- mm_final_df_345
me_final_df<- me_final_df_345
...
table(me_final_df$Student_Reported_EdTech_Use)
t.test(did_e ~ Student_Reported_EdTech_Use, data = me_final_df)
